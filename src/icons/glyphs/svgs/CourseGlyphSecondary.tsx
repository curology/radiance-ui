...
function SvgCourseGlyphSecondary(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        d="M39.76 38.7C34.55 33.8 25.71 33.55 24 33.55C18.06 33.55 12.33 35.41 8.28002 38.66C7.96002 38.92 7.90002 39.39 8.16002 39.71C8.31002 39.91 8.53002 40 8.75002 40C8.91002 40 9.08002 39.95 9.22002 39.83C13.01 36.79 18.39 35.05 24 35.05C25.62 35.05 33.93 35.28 38.74 39.79C39.04 40.07 39.52 40.06 39.8 39.76C40.08 39.46 40.07 38.99 39.76 38.7Z"
        fill="currentColor"
      />
      <path
