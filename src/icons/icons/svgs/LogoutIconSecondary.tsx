...
function SvgLogoutIconSecondary(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 16 16"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M14.81 0H9.36a.749.749 0 100 1.5h5.14v13H9.36a.749.749 0 100 1.5h5.45c.66 0 1.19-.54 1.19-1.2V1.2c0-.66-.54-1.2-1.19-1.2z"
        fill="currentColor"
      />
    </svg>
  );
