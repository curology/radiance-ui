...
function SvgImageIconSecondary(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={16}
      height={16}
    ...
    >
      ...
      />
      <path
        d="M11.45 8.55c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2a2 2 0 002 2zm0-2.5c.28 0 .5.22.5.5s-.22.5-.5.5-.5-.22-.5-.5.22-.5.5-.5z"
        fill="currentColor"
      />
    </svg>
  );
