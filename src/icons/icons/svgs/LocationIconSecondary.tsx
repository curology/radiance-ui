...
function SvgLocationIconSecondary(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={16}
      height={16}
    ...
    >
      ...
      />
      <path
        d="M9.86 5.17c0-1.09-.88-1.97-1.97-1.97-1.09 0-1.97.89-1.97 1.97s.88 1.97 1.97 1.97c1.09 0 1.97-.88 1.97-1.97zm-1.97.47a.47.47 0 11-.001-.939.47.47 0 01.001.939z"
        fill="currentColor"
      />
    </svg>
  );
